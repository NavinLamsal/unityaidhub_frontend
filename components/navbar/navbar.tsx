...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const isScrolledDown = currentScrollPos > 50; // Adjust the threshold as needed

      if (navbarRef.current) {
        navbarRef.current.style.transform = isScrolledDown ? "translateY(-100%)" : "translateY(0)";
      }
    };
...
//   };
  ...
  return (
    <div
    ref={navbarRef}
    className="w-full sticky top-0 bg-white text-black shadow-sm z-50 transition-transform duration-300"
  >
    <Wrapper>
