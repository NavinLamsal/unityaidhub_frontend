...
const BlogCard = ({blog}:{blog:any}) => {
  return (
    ...
    <p className="bg-Primary flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3 rounded-full uppercase w-fit ">{blog?.category}</p>
    <a className="text-sm font-bold sm:text-lg md:text-xl leading-6">{blog?.blog_title}</a>
    ...
    <div className="pt-2 pr-0 pb-0 pl-0">
      <a className="inline text-xs font-medium mt-0 mr-1 mb-0 ml-0 underline">{blog?.authorName}</a>
